...
public class DatabaseMenuRegulasi extends SQLiteOpenHelper {
	...
	// Query2 OJKTerbaru
	public int cekKosongOJKTerbaru() {
	...
	public void insertDataOJKTerbaru(int id, String itemtype, String title,
			String downloadurl, String filesize, String filetype,
			String parenturl, String url, String created, String sortdate,
			int isread) {
	...
	public void insertDataOJKTerbaruEn(int id, String itemtype, String title,
			String downloadurl, String filesize, String filetype,
			String parenturl, String url, String created, String sortdate,
			int isread) {
		SQLiteDatabase sqLiteDatabase = this.getWritableDatabase();
	...
	public ArrayList<ObjectItemListView> fetchDataOJKTerbaru() {
		...
		if (cursor.moveToFirst()) {
			do {
				ObjectItemListView ObjData = new ObjectItemListView(
	...
	public void updateFileSizeOJKTerbaruUsingUrlEn(String url, String fileSize) {
		...
		values.put("filesize", fileSize);
		sqLiteDatabase
				.update("OjkTerbaruEn", values, "url='" + url + "'", null);
	}
	...
	public void updateFileSizeGridEn(String url, String fileSize) {
		...
		ContentValues values = new ContentValues();
		values.put("filesize", fileSize);
		sqLiteDatabase.update("GridRegulasiEn", values, "url='" + url + "'",
				null);
	}
	...
	public void updateFileSizeGrid(String url, String fileSize) {
		...
		values.put("filesize", fileSize);
		sqLiteDatabase
				.update("GridRegulasi", values, "url='" + url + "'", null);
	}
	...
	public boolean cekDiOJKTerbaru(String url) {
		String queryCount = "select count(*) from OjkTerbaru where url = '"
				+ url + "'";
		SQLiteDatabase sqLiteDatabase = this.getReadableDatabase();
		Cursor cursor = sqLiteDatabase.rawQuery(queryCount, null);
		cursor.moveToFirst();
	...
	public String getIdDanIdParentDariDUrl(String downloadurl) {
		String hasil = "";
		String fetchdata = "select id, idparent from GridRegulasi where downloadurl= '"
				+ downloadurl + "'";
		SQLiteDatabase sqLiteDatabase = this.getReadableDatabase();
		Cursor cursor = sqLiteDatabase.rawQuery(fetchdata, null);
		if (cursor.moveToFirst()) {
	...
	public String getIdDanIdParentDariDUrlEn(String downloadurl) {
		String hasil = "";
		String fetchdata = "select id, idparent from GridRegulasiEn where downloadurl='"
				+ downloadurl + "'";
		SQLiteDatabase sqLiteDatabase = this.getReadableDatabase();
		Cursor cursor = sqLiteDatabase.rawQuery(fetchdata, null);
		if (cursor.moveToFirst()) {
	...
	public int getIdParentFromUrlEn(String url) {
		String queryCount = "select idparent from GridRegulasiEn where url = '"
				+ url + "'";
		SQLiteDatabase sqLiteDatabase = this.getReadableDatabase();
		Cursor cursor = sqLiteDatabase.rawQuery(queryCount, null);
		cursor.moveToFirst();
	...
	public int getIdParentFromUrl(String url) {
		String queryCount = "select idparent from GridRegulasi where url = '"
				+ url + "'";
		SQLiteDatabase sqLiteDatabase = this.getReadableDatabase();
		Cursor cursor = sqLiteDatabase.rawQuery(queryCount, null);
		cursor.moveToFirst();
	...
	public int getAnakCountEn(int id) {
		String queryCount = "select anakcount from MenuRegulasiEn where id = "
				+ id;
		SQLiteDatabase sqLiteDatabase = this.getReadableDatabase();
		Cursor cursor = sqLiteDatabase.rawQuery(queryCount, null);
		cursor.moveToFirst();
	...
	public int getAnakCount(int id) {
		String queryCount = "select anakcount from MenuRegulasi where id = "
				+ id;
		SQLiteDatabase sqLiteDatabase = this.getReadableDatabase();
		Cursor cursor = sqLiteDatabase.rawQuery(queryCount, null);
		cursor.moveToFirst();
	...
	public int getIdParentEn(int id) {
		String queryCount = "select idparent from MenuRegulasiEn where id = "
				+ id;
		SQLiteDatabase sqLiteDatabase = this.getReadableDatabase();
		Cursor cursor = sqLiteDatabase.rawQuery(queryCount, null);
		cursor.moveToFirst();
	...
	public int getIdParent(int id) {
		String queryCount = "select idparent from MenuRegulasi where id = "
				+ id;
		SQLiteDatabase sqLiteDatabase = this.getReadableDatabase();
		Cursor cursor = sqLiteDatabase.rawQuery(queryCount, null);
		cursor.moveToFirst();
	...
	public boolean isLastChild(int id) {
		String queryCount = "select islastchild from MenuRegulasi where id = "
				+ id;
		SQLiteDatabase sqLiteDatabase = this.getReadableDatabase();
		Cursor cursor = sqLiteDatabase.rawQuery(queryCount, null);
		cursor.moveToFirst();
	...
	public boolean isReadEn(int id) {
		String queryCount = "select isread from GridRegulasiEn where id = "
				+ id;
		SQLiteDatabase sqLiteDatabase = this.getReadableDatabase();
		Cursor cursor = sqLiteDatabase.rawQuery(queryCount, null);
		cursor.moveToFirst();
	...
	public int getCountGridUnread(int idparent) {
		String queryCount = "select count(*) from GridRegulasi where isread = 0 and idparent = "
				+ idparent;
		SQLiteDatabase sqLiteDatabase = this.getReadableDatabase();
		Cursor cursor = sqLiteDatabase.rawQuery(queryCount, null);
		cursor.moveToFirst();
	...
	public void insertDataGridEn(int id, String title, String downloadurl,
			String filesize, String filetype, String parenturl, int idparent,
			int isread, String createdOn, String downloadedOn, String url) {
		SQLiteDatabase sqLiteDatabase = this.getWritableDatabase();
		ContentValues values = new ContentValues();
		values.put("id", id);
		values.put("title", title);
	...
	public void insertDataGrid(int id, String title, String downloadurl,
			String filesize, String filetype, String parenturl, int idparent,
			int isread, String createdOn, String downloadedOn, String url) {
		SQLiteDatabase sqLiteDatabase = this.getWritableDatabase();
		ContentValues values = new ContentValues();
	...
	public void insertDataEn(int id, String title, String url, int idParent,
			int isLastChild, int anakCount) {
		SQLiteDatabase sqLiteDatabase = this.getWritableDatabase();
		ContentValues values = new ContentValues();
		values.put("id", id);
		values.put("title", title);
	...
	public void insertData(int id, String title, String url, int idParent,
			int isLastChild, int anakCount) {
		SQLiteDatabase sqLiteDatabase = this.getWritableDatabase();
		ContentValues values = new ContentValues();
		values.put("id", id);
	...
	public ArrayList fetchTitleGridFromParentURLEn(int idparent) {
		...
		String fetchdata = "select title from GridRegulasiEn where idparent = "
				+ idparent;
		SQLiteDatabase sqLiteDatabase = this.getReadableDatabase();
		Cursor cursor = sqLiteDatabase.rawQuery(fetchdata, null);
		if (cursor.moveToFirst()) {
	...
	public ArrayList fetchTitleGridFromParentURL(int idparent) {
		ArrayList<String> stringArrayList = new ArrayList<String>();
		String fetchdata = "select title from GridRegulasi where idparent = "
				+ idparent;
		SQLiteDatabase sqLiteDatabase = this.getReadableDatabase();
		Cursor cursor = sqLiteDatabase.rawQuery(fetchdata, null);
		if (cursor.moveToFirst()) {
	...
	public ArrayList fetchDataOjkDebug() {
		ArrayList<String> stringArrayList = new ArrayList<String>();
		String fetchdata = "select * from OjkTerbaru";
		SQLiteDatabase sqLiteDatabase = this.getReadableDatabase();
		Cursor cursor = sqLiteDatabase.rawQuery(fetchdata, null);
		if (cursor.moveToFirst()) {
			do {
				...
				stringArrayList.add("" + cursor.getInt(10));
			} while (cursor.moveToNext());
		}
		return stringArrayList;
	}
	...
	public ArrayList<ObjectItemGridView> fetchObjectAllGridEn() {
		...
		if (cursor.moveToFirst()) {
			do {
				ObjectItemGridView ObjData = new ObjectItemGridView(
	...
	public ArrayList<ObjectItemGridView> fetchObjectSearchRegulasi(
			String yangDicari) {
		ArrayList<ObjectItemGridView> ListOfObj = new ArrayList<ObjectItemGridView>();

		String fetchdata = "select * from GridRegulasi where title like "
				+ yangDicari;
		SQLiteDatabase sqLiteDatabase = this.getReadableDatabase();
		Cursor cursor = sqLiteDatabase.rawQuery(fetchdata, null);
		if (cursor.moveToFirst()) {
	...
	public ArrayList<ObjectItemGridView> fetchObjectFromIDParentGridEn(
			int idparent) {
		ArrayList<ObjectItemGridView> ListOfObj = new ArrayList<ObjectItemGridView>();

		String fetchdata = "select * from GridRegulasiEn where idparent = "
				+ idparent;
		SQLiteDatabase sqLiteDatabase = this.getReadableDatabase();
		Cursor cursor = sqLiteDatabase.rawQuery(fetchdata, null);
		if (cursor.moveToFirst()) {
	...
	public ArrayList<ObjectItemGridView> fetchObjectFromIDParentGrid(
			int idparent) {
		ArrayList<ObjectItemGridView> ListOfObj = new ArrayList<ObjectItemGridView>();

		String fetchdata = "select * from GridRegulasi where idparent = "
				+ idparent;
		SQLiteDatabase sqLiteDatabase = this.getReadableDatabase();
		Cursor cursor = sqLiteDatabase.rawQuery(fetchdata, null);
		if (cursor.moveToFirst()) {
	...
	public int getCountFromIDParentEn(int idParent) {
		String queryCount = "select count(*) from MenuRegulasiEn where idparent = "
				+ idParent;
		SQLiteDatabase sqLiteDatabase = this.getReadableDatabase();
		Cursor cursor = sqLiteDatabase.rawQuery(queryCount, null);
		cursor.moveToFirst();
	...
	public int getCountFromIDParent(int idParent) {
		String queryCount = "select count(*) from MenuRegulasi where idparent = "
				+ idParent;
		SQLiteDatabase sqLiteDatabase = this.getReadableDatabase();
		Cursor cursor = sqLiteDatabase.rawQuery(queryCount, null);
		cursor.moveToFirst();
